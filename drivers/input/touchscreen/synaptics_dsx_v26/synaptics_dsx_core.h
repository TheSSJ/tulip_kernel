...
#else
#error "undefine sstrtoul below 2.6.38"
#endif

#define CONFIG_CREATE_PROC_INTERFACE
#define CONFIG_CREATE_GLOVED_INTERFACE

#define CONFIG_WAKE_GESTURE_INTERFACE

#define GESTURE_TAP	KEY_WAKEUP

#define GESTURE_CHAR_W	KEY_WAKEUP

#define GESTURE_V	KEY_WAKEUP
#define GESTURE_O	KEY_WAKEUP

#define GESTURE_UP	KEY_WAKEUP
#define GESTURE_DOWN	KEY_WAKEUP
#define GESTURE_LEFT	KEY_WAKEUP
#define GESTURE_RIGHT	KEY_WAKEUP
