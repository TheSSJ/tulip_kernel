...
{
	//At the moment s2w doesn't work reliably, I need to fiddle around, therefore make the activation impossible
		...
		struct device_attribute *attr, const char *buf, size_t count)
{
	//0 = disabled
	//1 = left to right
	//2 = right to left, unfortunately unsupported option in Kernel Adiutor at the moment
...
late_initcall(wake_gestures_init);
