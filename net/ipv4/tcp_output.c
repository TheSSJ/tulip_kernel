...
#define tcp_socket_debugfs_tcp	0x00000001
#define tcp_socket_debugfs_ip	0x00000002
#define tcp_socket_debugfs_pm	0x00000004
/*ZTE_LC_TCP_DEBUG, 20130116 end*/
...
bool socket_debugfs_tcp_enable(void)
{
	if (tcp_socket_debugfs & tcp_socket_debugfs_tcp)
		return true;
	else
		return false;
}
EXPORT_SYMBOL(socket_debugfs_tcp_enable);
bool socket_debugfs_ip_enable(void)
{
	if (tcp_socket_debugfs & tcp_socket_debugfs_ip)
		return true;
	else
		return false;
}
EXPORT_SYMBOL(socket_debugfs_ip_enable);
bool socket_debugfs_pm_enable(void)
{
	if (tcp_socket_debugfs & tcp_socket_debugfs_pm)
		return true;
	else
		return false;
}
EXPORT_SYMBOL(socket_debugfs_pm_enable);
